...
export function FloatingAdd() {
  ...
  return (
    <motion.button
      ...
      className="md:hidden fixed bottom-20 right-5 z-40 h-[52px] w-[52px] rounded-full bg-gradient-to-br from-[var(--brand)] to-[#06B6D4] flex items-center justify-center text-white"
